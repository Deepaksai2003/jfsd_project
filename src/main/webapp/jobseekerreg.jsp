...
<center><font style="color:red;">${msg}</font></center>
  <div class="container2">    
    <div class="registration form">
      ...
      <form:form action="insertjs" modelAttribute="JobSeeker" method="post" enctype="multipart/form-data">
        ...
        <br/>
        <br/>
        <form:form action="insertjs" modelAttribute="JobSeeker" method="post" >
